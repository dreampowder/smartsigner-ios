...
struct PoolItem{
	...
	var lastEditDateAsString : String!
	var ownerUserId : Int!
    ...
    var poolLastEditDate: String! //Dağıtım Onay için gerekli
	/**
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		lastEditDateAsString = dictionary["LastEditDateAsString"] as? String
	...
	func toDictionary() -> [String:Any]
	{
        ...
        if lastEditDateAsString != nil{
			dictionary["LastEditDateAsString"] = lastEditDateAsString
		}
		if ownerUserId != nil{
